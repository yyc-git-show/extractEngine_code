(function () {
    var spriteFactory = {
        ...
        createEnemy: function () {
            return new EnemySprite(getSpriteData("enemy"), bitmapFactory.createBitmap({ img: window.imgLoader.get("enemy"), width: bomberConfig.enemy.IMGWIDTH, height: bomberConfig.enemy.IMGHEIGHT}));
        },
        createEnemy2: function () {
            return new EnemySprite(getSpriteData("enemy2"), bitmapFactory.createBitmap({ img: window.imgLoader.get("enemy"), width: bomberConfig.enemy.IMGWIDTH, height: bomberConfig.enemy.IMGHEIGHT }));
        },
