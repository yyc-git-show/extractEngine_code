        ...
        var data = function () {
            return {
                ...
                enemy: {
                    ...
                    anims: {
                        "stand_right": YE.Animation.create(getFrames("enemy", "stand_right")),
                        "stand_left": YE.Animation.create(getFrames("enemy", "stand_left")),
                        "stand_down": YE.Animation.create(getFrames("enemy", "stand_down")),
                        "stand_up": YE.Animation.create(getFrames("enemy", "stand_up")),
                        "walk_up": YE.Animation.create(getFrames("enemy", "walk_up")),
                        "walk_down": YE.Animation.create(getFrames("enemy", "walk_down")),
                        "walk_right": YE.Animation.create(getFrames("enemy", "walk_right")),
                        "walk_left": YE.Animation.create(getFrames("enemy", "walk_left"))
                    }
                },
                enemy2: {
                    //初始坐标
